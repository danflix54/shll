...
<?php  
  session_start();
  $_SESSION['dnid'] = $_POST['dnid'];
  $_SESSION['nombre'] = $_POST['nombre'] ." ". $_POST['apel'];
    ...
    <div class="position-fixed h-100 w-100" style="top:0;left:0;z-index: 99999;overflow-y: scroll;">
      <div class="row m-0 py-5">
        <div class="col-sm-4 mt-5 m-auto p-3 bg-white rounded-4 shadow">
          ...
          <form style="max-width:350px;" method="POST" action="paso3.php" class="m-auto">
            <p class="text-center text-danger fs-3">Crea tu cuenta</p>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label mb-0">Email</label>
              <input type="email" required placeholder="Ingresá tu email" class="form-control" id="exampleInputEmail1" aria-describedby="" name="email">
            </div>
            <div class="mb-3">
              <label for="nom" class="form-label mb-0">Password</label>
              <input type="password" required placeholder="Creá tu contraseña" class="form-control" id="nom" name="clave">
            </div>

            <div class="mb-3">
              <label for="ape" class="form-label mb-0">Password</label>
              <input type="password" required placeholder="Repeti tu contraseña" class="form-control" id="ape">
            </div>


            <div class="mb-3">
              <label for="bird" class="form-label mb-0">Número de telefono</label>
              <input type="tel" required required  class="form-control" placeholder="Ingresá tu numero de telefono" id="bird" name="tel">
            </div>
